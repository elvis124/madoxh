...
<input type="text" name="code" placeholder="optional" class="form-control">

</div><!-- form-group Ends -->

<input class="btn btn-primary"  style='background-color: red' type="submit" name="apply_coupon" value="Apply Coupon Code">
...
<button class="btn btn-default" style='background-color: white' type="submit" name="update" value="Update Cart">

<i class="fa fa-refresh"></i> Delete

</button>

<a href="checkout.php" class="btn btn-primary" style='background-color: orange'>
